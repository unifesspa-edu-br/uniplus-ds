# ADRs — Uni+ Design System

Registros de decisão de arquitetura **locais ao design system** (`uniplus-ds`).
São distintos dos ADRs da plataforma (ADR-001…018), que vivem em `uniplus-docs`.
A numeração aqui é independente e prefixada por escopo do DS.
